...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--nThreads', default=4, type=int, help='# threads for loading data')#4
        ...
        parser.add_argument('--max_dataset_size', type=int, default=1,help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.') #float("inf")
