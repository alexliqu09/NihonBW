...
#import pickle
cfg = get_cfg() #https://github.com/facebookresearch/detectron2/blob/master/configs/COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml
cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml"))
cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.7
cfg.MODEL.DEVICE = "cpu"
cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url("COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml")
#weigth=open('./checkpoints/model_final_2d9806.pkl','rb')
#cfg.MODEL.WEIGHTS = os.path.join("../checkpoints/model_final_2d9806.pkl")
predictor = DefaultPredictor(cfg)
parser = ArgumentParser()
parser.add_argument("--test_img_dir", type=str, default='train_dataset/test', help='testing images folder')
